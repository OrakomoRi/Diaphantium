...
module.exports = async (req, res) => {
	...
	if (!latest?.version) {
		return res.status(500).json({ error: 'Latest version has no version field' });
	}

	const url = `https://github.com/OrakomoRi/Diaphantium/releases/download/${latest.version}/diaphantium.client.js`;
